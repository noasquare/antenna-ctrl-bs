					...
					<div.txbody>
						...
						<div.tuop>
							<div[d:vflex ja:center h:25%]>
								<div[pos:relative p:2 w:60% c:gray3 bgc:teal8/40 bd:solid 1px teal4 rd:5px d:grid gtc:1fr 1fr]> for item,index in data[antindex].Devices[ctrindex].StatusList # 就tm多了一个操作，连通性就断掉了。
									<div[pos:absolute r:0 t:0 fs:medium c:white bgc:teal6/60 p:0 2 rd:0 0 4 4 ]> data[antindex].Devices[ctrindex].DevName
